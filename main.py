...
from app_context_service import (
    _profile_photo_context,
    _profile_photo_path,
    add_account_activity,
    enforce_step_flow as _enforce_step_flow,
    ensure_current_session_tracked as _ensure_current_session_tracked,
    load_general_settings,
    require_worker_microsoft_login as _require_worker_microsoft_login,
